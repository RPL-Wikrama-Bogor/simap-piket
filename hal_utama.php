...
<!-- END CONTENT -->
	<?php 
		switch (@$_GET['menu']) {
			...
			case 'master_siswa' : include 'master/master_siswa.php'; break;
			case 'master_rombel' : include 'master/master_rombel.php'; break;
			case 'master_rayon' : include 'master/master_rayon.php'; break;		
			case 'edit_siswa' : include 'master/edit_siswa.php'; break;	
